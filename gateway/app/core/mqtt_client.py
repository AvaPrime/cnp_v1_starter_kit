...
from .storage import insert_event, insert_error, insert_ack, upsert_command_result
                ...
                async with Client(
                    ...
                    async with client.filtered_messages("cnp/v1/nodes/+/+") as messages:
                        ...
                        async for message in messages:
                            await self._handle(message.topic, message.payload.decode())
            except (MqttError, asyncio.CancelledError):
